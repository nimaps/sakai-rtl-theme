...
sakai.editor.editors.ckeditor.launch = function (targetId, config, w, h) {
  ...
  if (sakai.editor.editors.ckeditor.browser === "elfinder") {
    var elfinderUrl =
      "/library/editor/elfinder/sakai/elfinder.html?connector=elfinder-connector/elfinder-servlet/connector";
    ...
    var filebrowser = {
      ...
      imageBrowseUrl:
        elfinderUrl + "&startdir=" + collectionId + "&type=images",
      flashBrowseUrl: elfinderUrl + "&startdir=" + collectionId + "&type=flash",
    };
  } else {
    var fckeditorUrl =
      "/library/editor/FCKeditor/editor/filemanager/browser/default/browser.html" +
    ...
    var filebrowser = {
      ...
      imageBrowseUrl:
        fckeditorUrl + collectionId + "&" + folder + "&Type=Image",
      flashBrowseUrl:
        fckeditorUrl + collectionId + "&" + folder + "&Type=Flash",
    };
  }
  ...
  (function () {
    ...
    if (
      typeof portal != "undefined" &&
      typeof portal.editor != "undefined" &&
      typeof portal.editor.type == "string"
    ) {
    ...
    CKEDITOR.plugins.addExternal(
      "iframedialog",
      basePath + "iframedialog/",
      "plugin.js"
    );
    CKEDITOR.plugins.addExternal(
      "html5video",
      webJars +
        "github-com-bahriddin-ckeditor-html5-video/${ckeditor.html5video.version}/html5video/",
      "plugin.js"
    );
    CKEDITOR.plugins.addExternal(
      "audiorecorder",
      basePath + "audiorecorder/",
      "plugin.js"
    );
    CKEDITOR.plugins.addExternal(
      "contentitem",
      basePath + "contentitem/",
      "plugin.js"
    );
    CKEDITOR.plugins.addExternal(
      "sakaipreview",
      basePath + "sakaipreview/",
      "plugin.js"
    );
    CKEDITOR.plugins.addExternal(
      "bt_table",
    ...
    CKEDITOR.plugins.addExternal(
      "image2",
      webJars + "ckeditor-image2/${ckeditor.image2.version}/",
      "plugin.js"
    );
    ...
    CKEDITOR.plugins.addExternal(
      "autosave",
      webJars + "ckeditor-autosave/${ckeditor.autosave.version}/",
      "plugin.js"
    );
    CKEDITOR.plugins.addExternal(
      "wordcount",
      webJars + "wordcount/${ckeditor.wordcount.version}/",
      "plugin.js"
    );
    CKEDITOR.plugins.addExternal(
      "notification",
    ...
    CKEDITOR.plugins.addExternal(
      "balloonpanel",
      webJars + "balloonpanel/${ckeditor.balloonpanel.version}/",
      "plugin.js"
    );
    CKEDITOR.plugins.addExternal(
      "a11ychecker",
      webJars + "a11ychecker/${ckeditor.a11ychecker.version}/",
      "plugin.js"
    );
    /*
    ...
    ckconfig.extraPlugins +=
      "${ckeditor-extra-plugins}${ckeditor-a11y-extra-plugins}";

    // Load FontAwesome CSS in case a user wants to manually add FA markup
    ckconfig.contentsCss.push(
    ...
    ckconfig.specialChars = CKEDITOR.config.specialChars.concat([
      ["&alpha;", "alpha"],
      ["&beta;", "beta"],
      ["&gamma;", "gamma"],
      ["&delta;", "delta"],
